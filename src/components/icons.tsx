/**
 * Brand marks that lucide-react doesn't ship (it dropped brand icons — its `X`
 * is the close/cross glyph, not the X logo). Same props shape as lucide icons
 * so they're interchangeable at call sites.
 */
type IconProps = {
  className?: string;
...
export function LinkedInLogo({ className, ...props }: IconProps) {
  return (
    <svg
